...
export class QuickJSAsyncFFI {
  ...
  QTS_SetHostCallback: (
    fp: QTS_C_To_HostCallbackFuncPointer
  ) => void = this.module.cwrap('QTS_SetHostCallback', null, ['number'])
  ...
  QTS_NewFunction: (
    ...
    func_data: JSValuePointer | JSValueConstPointer,
    name: string
  ...
  QTS_SetInterruptCallback: (
    cb: QTS_C_To_HostInterruptFuncPointer
  ) => void = this.module.cwrap('QTS_SetInterruptCallback', null, ['number'])

  QTS_RuntimeEnableInterruptHandler: (
    rt: JSRuntimePointer
  ) => void = this.module.cwrap('QTS_RuntimeEnableInterruptHandler', null, ['number'])
  ...
  QTS_RuntimeSetMemoryLimit: (
    rt: JSRuntimePointer,
    limit: number
  ) => void = this.module.cwrap('QTS_RuntimeSetMemoryLimit', null, ['number', 'number'])

  QTS_RuntimeComputeMemoryUsage: (
    rt: JSRuntimePointer,
    ctx: JSContextPointer
  ) => JSValuePointer = this.module.cwrap('QTS_RuntimeComputeMemoryUsage', 'number', [
    'number',
    'number',
  ])
  ...
  QTS_RuntimeDumpMemoryUsage: (
    rt: JSRuntimePointer
  ) => string = this.module.cwrap('QTS_RuntimeDumpMemoryUsage', 'string', ['number'])
  ...
  QTS_NewFloat64: (
    ctx: JSContextPointer,
    num: number
  ) => JSValuePointer = this.module.cwrap('QTS_NewFloat64', 'number', ['number', 'number'])

  QTS_GetFloat64: (
    ctx: JSContextPointer,
    value: JSValuePointer | JSValueConstPointer
  ) => number = this.module.cwrap('QTS_GetFloat64', 'number', ['number', 'number'])

  QTS_NewString: (
    ctx: JSContextPointer,
    string: HeapCharPointer
  ) => JSValuePointer = this.module.cwrap('QTS_NewString', 'number', ['number', 'number'])

  QTS_GetString: (
    ctx: JSContextPointer,
    value: JSValuePointer | JSValueConstPointer
  ) => string = this.module.cwrap('QTS_GetString', 'string', ['number', 'number'])
  ...
  ) => JSValuePointer = this.module.cwrap('QTS_ResolveException', 'number', ['number', 'number'])
  ...
  QTS_Typeof: (
    ctx: JSContextPointer,
    value: JSValuePointer | JSValueConstPointer
  ) => string = this.module.cwrap('QTS_Typeof', 'string', ['number', 'number'])

  QTS_GetGlobalObject: (
    ctx: JSContextPointer
  ) => JSValuePointer = this.module.cwrap('QTS_GetGlobalObject', 'number', ['number'])
