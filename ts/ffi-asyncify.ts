...
export class QuickJSAsyncFFI {
  ...
  QTS_NewAsyncFunction: (ctx: JSContextPointer, func_id: number, name: string) => JSValuePointer =
    this.module.cwrap("QTS_NewAsyncFunction", "number", ["number","number","string"])
  ...
  QTS_ExecutePendingJob: (rt: JSRuntimePointer, maxJobsToExecute: number, pctx: JSContextPointerPointer) => JSValuePointer =
    assertSync(this.module.cwrap("QTS_ExecutePendingJob", "number", ["number","number","number"]))

  QTS_ExecutePendingJob_MaybeAsync: (rt: JSRuntimePointer, maxJobsToExecute: number, pctx: JSContextPointerPointer) => JSValuePointer | Promise<JSValuePointer> =
