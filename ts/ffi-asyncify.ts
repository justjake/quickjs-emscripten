...
export class QuickJSAsyncFFI {
  ...
  QTS_GetString: (ctx: JSContextPointer, value: JSValuePointer | JSValueConstPointer) => OwnedHeapCharPointer =
  ...
  QTS_Dump: (ctx: JSContextPointer, obj: JSValuePointer | JSValueConstPointer) => OwnedHeapCharPointer =
