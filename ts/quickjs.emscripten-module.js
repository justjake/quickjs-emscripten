...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_QTS_CompileModule')) {
        Object.defineProperty(Module['ready'], '_QTS_CompileModule', { configurable: true, get: function() { abort('You are getting _QTS_CompileModule on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_QTS_CompileModule', { configurable: true, set: function() { abort('You are setting _QTS_CompileModule on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
function qts_host_load_module(rt,ctx,module_name){ const asyncify = undefined; return Module.callbacks.loadModule(asyncify, rt, ctx, module_name); }
