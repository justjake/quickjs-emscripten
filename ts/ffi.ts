...
export class QuickJSFFI {
  ...
  QTS_NewString: (
    ctx: JSContextPointer,
    string: string
  ) => JSValuePointer = this.module.cwrap('QTS_NewString', 'number', ['number', 'string'])
  ...
  ) => string = this.module.cwrap('QTS_Dump', 'string', ['number', 'number'])

  QTS_Eval: (
    ctx: JSContextPointer,
    js_code: string
  ) => JSValuePointer = this.module.cwrap('QTS_Eval', 'number', ['number', 'string'])
  ...
  QTS_DupValue: (
    ctx: JSContextPointer,
    value_ptr: JSValuePointer | JSValueConstPointer
  ) => JSValuePointer = this.module.cwrap('QTS_DupValue', 'number', ['number', 'number'])
