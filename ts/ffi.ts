...
export class QuickJSFFI {
  ...
  QTS_DB_New: () => sqlite3Pointer =
    this.module.cwrap("QTS_DB_New", "number", [])

  QTS_DB_Close: (db: sqlite3Pointer) => void =
    this.module.cwrap("QTS_DB_Close", null, ["number"])

  QTS_DB_Exec: (db: sqlite3Pointer, sql: HeapCharPointer, print_instead: number) => HeapCharPointer =
    this.module.cwrap("QTS_DB_Exec", "number", ["number","number","number"])
}
