...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_QTS_DupValue')) {
        Object.defineProperty(Module['ready'], '_QTS_DupValue', { configurable: true, get: function() { abort('You are getting _QTS_DupValue on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_QTS_DupValue', { configurable: true, set: function() { abort('You are setting _QTS_DupValue on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 71632,
    DYNAMIC_BASE = 5314512,
    DYNAMICTOP_PTR = 71472;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 71536, 4), 71536);
...
/** @type {function(...*):?} */
var _QTS_DupValue = Module["_QTS_DupValue"] = createExportWrapper("QTS_DupValue");
