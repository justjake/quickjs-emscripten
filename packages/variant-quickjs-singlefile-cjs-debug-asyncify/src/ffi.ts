...
export class QuickJSAsyncFFI {
  ...
  QTS_ExecuteCommands: (
    ...
    jsvalue_slots: JSValuePointer,
    jsvalue_slots_count: number,
    funclist_slots: JSVoidPointer,
    funclist_slots_count: number,
    out_status: UInt32Pointer,
    out_error: UInt32Pointer,
  ) => number = this.module.cwrap("QTS_ExecuteCommands", "number", [
    "number",
    "number",
    "number",
    "number",
