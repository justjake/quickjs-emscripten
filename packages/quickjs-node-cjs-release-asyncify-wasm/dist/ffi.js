...
const quickjs_ffi_types_1 = require("@jitl/quickjs-ffi-types");
/**
...
class QuickJSAsyncFFI {
    constructor(module) {
        ...
        this.QTS_GetSymbolDescriptionOrKey = (0, quickjs_ffi_types_1.assertSync)(this.module.cwrap("QTS_GetSymbolDescriptionOrKey", "number", ["number", "number"]));
        ...
        this.QTS_ExecutePendingJob = (0, quickjs_ffi_types_1.assertSync)(this.module.cwrap("QTS_ExecutePendingJob", "number", ["number", "number", "number"]));
        this.QTS_ExecutePendingJob_MaybeAsync = this.module.cwrap("QTS_ExecutePendingJob", "number", ["number", "number", "number"]);
        this.QTS_GetProp = (0, quickjs_ffi_types_1.assertSync)(this.module.cwrap("QTS_GetProp", "number", ["number", "number", "number"]));
        this.QTS_GetProp_MaybeAsync = this.module.cwrap("QTS_GetProp", "number", ["number", "number", "number"]);
        this.QTS_SetProp = (0, quickjs_ffi_types_1.assertSync)(this.module.cwrap("QTS_SetProp", null, ["number", "number", "number", "number"]));
        ...
        this.QTS_Call = (0, quickjs_ffi_types_1.assertSync)(this.module.cwrap("QTS_Call", "number", ["number", "number", "number", "number", "number"]));
        ...
        this.QTS_Dump = (0, quickjs_ffi_types_1.assertSync)(this.module.cwrap("QTS_Dump", "number", ["number", "number"]));
        this.QTS_Dump_MaybeAsync = this.module.cwrap("QTS_Dump", "number", ["number", "number"]);
        this.QTS_Eval = (0, quickjs_ffi_types_1.assertSync)(this.module.cwrap("QTS_Eval", "number", ["number", "number", "string", "number", "number"]));
