...
export interface QuickJSAsyncFFI {
  ...
  QTS_ExecuteCommands: (ctx: JSContextPointer, command_count: number, commands: CommandPointer, jsvalue_slots: JSValuePointer, jsvalue_slots_count: number, funclist_slots: JSVoidPointer, funclist_slots_count: number, out_status: UInt32Pointer, out_error: UInt32Pointer) => number
}
