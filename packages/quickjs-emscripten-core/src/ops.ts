...
export function SlotFreeCmd(targetSlot: number, targetSlotType: SlotType): SlotFreeCommand {
  return {
    kind: SLOT_FREE,
    targetSlot,
    targetSlotType,
...
export function writeNewArraybuffer(view: DataView, offset: CommandPtr, result_slot: JSValueSlot, class_is_shared_array_buffer: Uint8, data_ptr: JSVoidPointer, data_len: Uint32): void {
