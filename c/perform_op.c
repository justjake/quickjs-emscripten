...
QTS_CommandStatus QTS_PerformOp(QTS_CommandEnv *env, QTS_Command cmd) {
    switch (cmd.opcode) {
        ...
        case QTS_OP_SET_STR_VALUE: return perform_set_str_value(env, (JSValueSlot)cmd.slot_a, (JSValueSlot)cmd.slot_b, (JSPropFlags)cmd.slot_c, cmd.data.buf.ptr, cmd.data.buf.len);
        case QTS_OP_SET_STR_NULL: return perform_set_str_null(env, (JSValueSlot)cmd.slot_a, (JSPropFlags)cmd.slot_c, cmd.data.buf.ptr, cmd.data.buf.len);
        case QTS_OP_SET_STR_UNDEF: return perform_set_str_undef(env, (JSValueSlot)cmd.slot_a, (JSPropFlags)cmd.slot_c, cmd.data.buf.ptr, cmd.data.buf.len);
        case QTS_OP_SET_STR_BOOL: return perform_set_str_bool(env, (JSValueSlot)cmd.slot_a, cmd.slot_b, (JSPropFlags)cmd.slot_c, cmd.data.buf.ptr, cmd.data.buf.len);
        case QTS_OP_SET_STR_INT32: return perform_set_str_int32(env, (JSValueSlot)cmd.slot_a, (JSPropFlags)cmd.slot_c, cmd.data.buf.ptr, cmd.data.buf.len, (int32_t)cmd.data.buf.extra);
        case QTS_OP_SET_STR_F64: return perform_set_str_f64(env, (JSValueSlot)cmd.slot_a, cmd.slot_b, (JSPropFlags)cmd.slot_c, cmd.data.f64.value, (char*)cmd.data.f64.extra);
        case QTS_OP_SET_STR_BIGINT: return perform_set_str_bigint(env, (JSValueSlot)cmd.slot_a, cmd.slot_b, (JSPropFlags)cmd.slot_c, cmd.data.i64.value, (char*)cmd.data.i64.extra);
        case QTS_OP_SET_STR_STRING: return perform_set_str_string(env, (JSValueSlot)cmd.slot_a, cmd.slot_b, (JSPropFlags)cmd.slot_c, cmd.data.buf.ptr, cmd.data.buf.len, (char*)cmd.data.buf.extra);
        case QTS_OP_SET_IDX_VALUE: return perform_set_idx_value(env, (JSValueSlot)cmd.slot_a, (JSValueSlot)cmd.slot_b, cmd.data.raw.d1);
        ...
        case QTS_OP_SET: return perform_set(env, (JSValueSlot)cmd.slot_a, (JSValueSlot)cmd.slot_b, (JSValueSlot)cmd.slot_c, (JSPropFlags)cmd.data.raw.d1);
