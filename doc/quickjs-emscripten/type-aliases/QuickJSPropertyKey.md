...
[quickjs-emscripten](../../packages.md) / [quickjs-emscripten](../README.md) / QuickJSPropertyKey

# Type Alias: QuickJSPropertyKey

> **QuickJSPropertyKey** = `number` | `string` | [`QuickJSHandle`](QuickJSHandle.md)
