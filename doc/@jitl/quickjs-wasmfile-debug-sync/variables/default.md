...
[quickjs-emscripten](../../../packages.md) / [@jitl/quickjs-wasmfile-debug-sync](../README.md) / default

# Variable: default

> `const` **default**: [`QuickJSSyncVariant`](../../../quickjs-emscripten/interfaces/QuickJSSyncVariant.md)

Defined in: [index.ts:18](https://github.com/justjake/quickjs-emscripten/blob/main/packages/variant-quickjs-wasmfile-debug-sync/src/index.ts#L18)
