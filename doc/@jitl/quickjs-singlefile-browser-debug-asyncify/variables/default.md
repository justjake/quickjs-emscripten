...
[quickjs-emscripten](../../../packages.md) / [@jitl/quickjs-singlefile-browser-debug-asyncify](../README.md) / default

# Variable: default

> `const` **default**: [`QuickJSAsyncVariant`](../../../quickjs-emscripten/interfaces/QuickJSAsyncVariant.md)

Defined in: [index.ts:18](https://github.com/justjake/quickjs-emscripten/blob/main/packages/variant-quickjs-singlefile-browser-debug-asyncify/src/index.ts#L18)
