...
[quickjs-emscripten](../../../packages.md) / [@jitl/quickjs-singlefile-mjs-release-asyncify](../README.md) / default

# Variable: default

> `const` **default**: [`QuickJSAsyncVariant`](../../../quickjs-emscripten/interfaces/QuickJSAsyncVariant.md)

Defined in: [index.ts:18](https://github.com/justjake/quickjs-emscripten/blob/main/packages/variant-quickjs-singlefile-mjs-release-asyncify/src/index.ts#L18)
