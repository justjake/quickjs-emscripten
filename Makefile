...
ASYNCIFY_STACK_SIZE=81920

CFLAGS_WASM_ASYNCIFY+=-s ASYNCIFY=1
CFLAGS_WASM_ASYNCIFY+=-DQTS_ASYNCIFY=1
CFLAGS_WASM_ASYNCIFY+=-DQTS_ASYNCIFY_DEFAULT_STACK_SIZE=$(ASYNCIFY_STACK_SIZE)
CFLAGS_WASM_ASYNCIFY+=-s ASYNCIFY_STACK_SIZE=$(ASYNCIFY_STACK_SIZE)
